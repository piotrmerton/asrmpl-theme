...
{
    if (!tml_is_action() or !tml_is_action("register")) {
        return;
    }

    tml_add_form_field("register", "disclaimer", [
        "type" => "custom",
        "content" => sprintf(
            __(
                '<p>Zakładając konto akceptujesz <a href="%s">regulamin serwisu ASRoma.pl</a> oraz naszą <a href="%s">politykę prywatności</a>.</p>'
            ),

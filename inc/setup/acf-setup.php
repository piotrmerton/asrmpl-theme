...
define(
    "MY_ACF_PATH",
    get_stylesheet_directory() . "/inc/tools/advanced-custom-fields-pro/"
);
define(
    "MY_ACF_URL",
    get_stylesheet_directory_uri() . "/inc/tools/advanced-custom-fields-pro/"
);
...
define(
    "MY_ACFE_PATH",
    get_stylesheet_directory() . "/inc/tools/acf-extended-pro/"
);
define(
    "MY_ACFE_URL",
    get_stylesheet_directory_uri() . "/inc/tools/acf-extended-pro/"
);

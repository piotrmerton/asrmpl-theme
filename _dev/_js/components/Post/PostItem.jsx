        ...
        return(
            <li className={cssClass}>
                <a href={post.link}>   
                    ...
                    <h3 className="post__title" dangerouslySetInnerHTML={this.renderText(post.title.rendered)} /> 

                    {this.props.meta &&
                        <div className="post__meta">
                            <div className="post__date">
                                <figure className="ui-ico">
                                    <img loading="lazy" src={`${wp_core.theme_url}/assets/svg/ico/calendar.svg`} />
                                </figure>
                                <span className="label">{post.custom_data.date_display}</span>
                            </div>
                            <div className="post__comment-count">
                                <figure className="ui-ico">
                                    <img loading="lazy" src={`${wp_core.theme_url}/assets/svg/ico/comments.svg`} />
                                </figure>                                
                                <span className="label">{post.custom_data.comments_display}</span>
                            </div>
                        </div>                    
                    }

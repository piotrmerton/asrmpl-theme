...
$theme_endpoints = array(
    ...
    'shoutbox' => $rest_url . 'comments?skip_cache=1&post='.THEME_SHOUTBOUX_PAGE_ID,
);


$i18n = array(
    'no_playerstats' => __('Brak bieżących statystyk dla danego zawodnika.', 'theme'),
    'no_data' => __('Brak danych.', 'theme'),
    'no_events' => __('Na ten dzień nie przypada żadne istotne wydarzenie.', 'theme'),

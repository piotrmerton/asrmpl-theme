    ...
    return (
      <li className="grid__item item--video" data-video-id={id_video}>
        <a
          ...
          href={video.custom_data.youtube_url}
          onClick={(event) => this.playVideo(event, id_video)}
        >
          {video.custom_data.cover && (
            <div className="video__cover">
              <figure className="cover__image cover cover--overlay">
                <picture>
                  <source
                    srcSet={video.custom_data.cover.webp}
                    type="image/webp"
                  />
                  <source
                    srcSet={video.custom_data.cover.jpeg}
                    type="image/jpeg"
                  />
                  <img
                    loading="lazy"
                    src={video.custom_data.cover.jpeg}
                    width="480"
                    height="270"
                    alt={video.custom_data.cover.alt}
                  />
                </picture>
              ...
              <figure className="cover__ico">
                <img
                  loading="lazy"
                  src={`${wp_core.theme_url}/assets/svg/ico/play.svg`}
                />
              </figure>
            </div>
          )}
          ...
          <p
            ...
            dangerouslySetInnerHTML={this.renderText(video.title.rendered)}
          />
        </a>
      </li>
    );

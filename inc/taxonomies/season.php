...
register_taxonomy("season", "game", [
    "labels" => [
        ...
        "name_field_description" => __(
            "Pełna nazwa sezonu np. 2021/2022.",
            "theme_bo"
        ),
        "slug_field_description" => __(
            "Nazwa uproszczona składająca się z roku, w którym zaczyna się sezon, np. 2021 (na potrzeby przyjaznych URL lub zapytań do bazy danych)",
            "theme_bo"
        ),
    ],
    "show_ui" => true,
